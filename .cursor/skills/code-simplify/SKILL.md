---
name: code-simplify
description: Simplify code for clarity and maintainability — reduce complexity without changing behavior. Use when the user runs /code-simplify.
...
1. Study project conventions (`.cursor/rules/`, `AGENTS.md` if present)
